    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.patients.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hn') ? 'is-invalid' : '' }}" type="text" name="hn" id="hn" value="{{ old('hn', '') }}">
                @if($errors->has('hn'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nup') ? 'is-invalid' : '' }}" type="text" name="nup" id="nup" value="{{ old('nup', '') }}">
                @if($errors->has('nup'))
