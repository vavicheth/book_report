...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.emergency.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.emergencies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transfer_to_department') ? 'is-invalid' : '' }}" type="text" name="transfer_to_department" id="transfer_to_department" value="{{ old('transfer_to_department', '') }}">
