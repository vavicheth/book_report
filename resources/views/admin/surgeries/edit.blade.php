    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.surgeries.update", [$surgery->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('patient') ? 'is-invalid' : '' }}" name="patient_id" id="patient_id" required>
                    @foreach($patients as $id => $patient)
                        <option value="{{ $id }}" {{ ($surgery->patient ? $surgery->patient->id : old('patient_id')) == $id ? 'selected' : '' }}>{{ $patient }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('guardian') ? 'is-invalid' : '' }}" type="text" name="guardian" id="guardian" value="{{ old('guardian', $surgery->guardian) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('age_range') ? 'is-invalid' : '' }}" name="age_range" id="age_range">
                    ...
                    @foreach(App\Surgery::AGE_RANGE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('age_range', $surgery->age_range) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('transfer_from') ? 'is-invalid' : '' }}" type="text" name="transfer_from" id="transfer_from" value="{{ old('transfer_from', $surgery->transfer_from) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_admit') ? 'is-invalid' : '' }}" type="text" name="date_admit" id="date_admit" value="{{ old('date_admit', $surgery->date_admit) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diag_admit') ? 'is-invalid' : '' }}" type="text" name="diag_admit" id="diag_admit" value="{{ old('diag_admit', $surgery->diag_admit) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_surgery') ? 'is-invalid' : '' }}" type="text" name="date_surgery" id="date_surgery" value="{{ old('date_surgery', $surgery->date_surgery) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_discharged') ? 'is-invalid' : '' }}" type="text" name="date_discharged" id="date_discharged" value="{{ old('date_discharged', $surgery->date_discharged) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diag_discharged') ? 'is-invalid' : '' }}" type="text" name="diag_discharged" id="diag_discharged" value="{{ old('diag_discharged', $surgery->diag_discharged) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('discharged_form') ? 'is-invalid' : '' }}" name="discharged_form" id="discharged_form">
                    ...
                    @foreach(App\Surgery::DISCHARGED_FORM_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('discharged_form', $surgery->discharged_form) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cause_dead') ? 'is-invalid' : '' }}" type="text" name="cause_dead" id="cause_dead" value="{{ old('cause_dead', $surgery->cause_dead) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('mother_dead') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="mother_dead" id="mother_dead" value="1" {{ $surgery->mother_dead || old('mother_dead', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discharged_condition') ? 'is-invalid' : '' }}" type="text" name="discharged_condition" id="discharged_condition" value="{{ old('discharged_condition', $surgery->discharged_condition) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('day_stay') ? 'is-invalid' : '' }}" type="number" name="day_stay" id="day_stay" value="{{ old('day_stay', $surgery->day_stay) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('payment_type') ? 'is-invalid' : '' }}" name="payment_type" id="payment_type">
                    ...
                    @foreach(App\Surgery::PAYMENT_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('payment_type', $surgery->payment_type) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $surgery->note) }}</textarea>
                @if($errors->has('note'))
