...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ipd.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ipds.store") }}" enctype="multipart/form-data">
            @csrf
...
{{--            </div>--}}
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_start_sick') ? 'is-invalid' : '' }}" type="text" name="date_start_sick" id="date_start_sick" value="{{ old('date_start_sick') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('paraclinic') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="paraclinic" id="paraclinic" value="1" {{ old('paraclinic', 0) == 1 ? 'checked' : '' }}>
